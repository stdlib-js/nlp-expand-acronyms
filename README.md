...
```javascript
expandAcronyms = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp-expand-acronyms@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/nlp-expand-acronyms@umd/bundle.js"></script>
```
